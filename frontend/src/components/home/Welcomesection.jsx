/**
 * WelcomeSection
 * Full-width cloud wave banner + intro text
 */
      ...
      >
        ...
        <div className="relative max-w-3xl mx-auto text-center z-10">
          <h2 className="text-xl md:text-2xl font-extrabold text-[#e8175d] mb-3">
            Chào mừng bạn đến với sàn thương mại điện tử ZenGo
          </h2>
          <p className="text-sm md:text-base text-[#7a4040] leading-relaxed">
            Nơi hội tụ hàng ngàn sản phẩm chất lượng với giá cả cạnh tranh và dịch vụ tận tâm.
            Tại đây, bạn có thể mua sắm dễ dàng, thanh toán an toàn và nhận hàng nhanh chóng.
            ZenGo luôn đồng hành để mang đến trải nghiệm mua sắm tiện lợi và đáng tin cậy cho bạn.
          </p>
        </div>
      </div>
      <WaveBottom />
